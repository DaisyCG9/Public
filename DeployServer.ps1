...
$labelServer.Text = 'Please enter the name of a server at the same site (e.g. for Cedarville site use USCDAP100)'
...
#currently not working as a way to disable security prompt: Set-Item WSMan:\localhost\Client\TrustedHosts -Value "*.carmeuse.net" -Force
If ($checkboxTrend.Checked -eq $true){
Start-Process -FilePath '\\uspgfs002\Software\Trend Micro\2019\TMx64Silent.exe'
